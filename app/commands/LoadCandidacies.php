...
class LoadCandidacies extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'load:candidacies';
	 ...
	 * @var string
	 */
	protected $description = 'Loads a CSV of candidacies relating the candidates to the parties etc - creates new candidates & parties if they are missing.  CSV should be in xxxxxx format.';
	/**
