...
class MergeCandidates extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'merge:candidates';
	 ...
	 * @var string
	 */
	protected $description = 'Merge two candidates';
	...
	public function fire()
	{
        ...
        $this->line('Loser');
        $this->showCandidate($loser);
        $this->line('');
        $this->line('');
        
        
        
        $question = "Are you sure you want to merge the two candidates, the loser will be deleted (yes or no)";
      ...
      ",  array($winner, $loser));
            ...
            $loser = Candidate::find($loser);
            $loser->delete();
                
         
            $this->line('Merging completed.  Here is the merged candidate:');
            $this->line('');
            $this->showCandidate($winner);
    ...
    protected function showCandidate($id)
    {
        //dd($id);
